...
{
    softPwmWrite(1,500); //左轮back
	softPwmWrite(4,0); 
	softPwmWrite(5,500); //右轮back
  	softPwmWrite(6,0); 
...
int main()
{
  ...
  while(1){
    ...
    if(dis>4&&dis<30){   //测得前方障碍的距离大于4cm小于30cm时做出如下响应
     ...
     else if(dis>30&&dis<450){//测得前方障碍的距离大于30cm小于450cm时做出如下响应
